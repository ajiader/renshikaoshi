...
if (navigator.userAgent.indexOf("MSIE 6.0") > 0) {
    document.writeln('<div id="top_div" style="display:none"><a href="#"><img src=\"images/div_top.png\"  style="filter:alpha(opacity=100);bottom:40px;right:120px;_position:absolute; _TOP:expression(offsetParent.scrollTop+document.documentElement.clientHeight-this.offsetHeight-40);" onmouseover="visible(this,1)" onmouseout="visible(this,0)" /></a></div>');
} else {
    document.writeln('<div id="top_div" style="position:fixed; bottom:40px; right:60px; display:none;" ><a href="#"><img src=\"images/div_top.png\"  style="filter:alpha(opacity=100)" onmouseover="visible(this,1)" onmouseout="visible(this,0)" /></a></div>');
}
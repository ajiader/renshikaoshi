...
$LANG['setting_ftp_enable'] = '启用远程附件';
$LANG['setting_ftp_upload_url'] = 'ftp访问路径';
$LANG['setting_ftp_host'] = 'ftp地址';
$LANG['setting_ftp_user'] = 'ftp账号';
$LANG['setting_ftp_password'] = 'ftp密码';
$LANG['setting_ftp_path'] = 'ftp目录';
$LANG['setting_ftp_port'] = 'ftp端口';
$LANG['setting_ftp_pasv'] = '是否开启被动模式';

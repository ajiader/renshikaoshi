...
<div class="explain-col"> &nbsp;&nbsp;&nbsp;&nbsp;地方站标签：{$cityname}城市名称,{$catname}栏目名称 </div>
      ...
      <tr>
        <th>SEO名称：</th>
        <td><input name="info[name]" type="text" id="name" size="57" /></td>
      </tr>
      <tr>
      <th>标题：</th><td><input name="info[title]" type="text" id="title" size="57" /></td></tr>
      
      <tr>
      <th>关键词：</th><td id="addcat"><textarea name="info[keywords]" id="keywords" style="width:350px;height:100px;"></textarea></td></tr>

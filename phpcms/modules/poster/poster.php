...
class poster extends admin {
	...
	public function add() {
		if (isset($_POST['dosubmit'])) {
			...
			if ($id) {
				...
				showmessage(L('add_ads_success'), 'goshouye.php?m=poster&c=space&a=init');
			} else {
				showmessage(L('operation_failure'), 'goshouye.php?m=poster&c=space&a=init');
			}
		} else {
	...
	public function edit() {
		...
		if (isset($_POST['dosubmit'])) {
			...
			showmessage(L('edit_ads_success'), 'goshouye.php?m=poster&c=poster&a=init&spaceid='.$_GET['spaceid']);
		} else {

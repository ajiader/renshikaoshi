...
<table width="100%"  class="table_form">
  ...
  <tr>
    <th width="120"><?php echo L('setting_ftp_enable')?></th>
    <td class="y-bg">
    <input name="setconfig[ftp_enable]" value="1"  type="radio"  <?php echo ($ftp_enable=='1') ? ' checked' : ''?>> <?php echo L('setting_yes')?>&nbsp;&nbsp;&nbsp;&nbsp;
	<input name="setconfig[ftp_enable]" value="0" type="radio"  <?php echo ($ftp_enable=='0') ? ' checked' : ''?>> <?php echo L('setting_no')?></td>
  </tr> 
    <tr>
    <th width="120"><?php echo L('setting_ftp_pasv')?></th>
    <td class="y-bg"><input name="setconfig[ftp_pasv]" value="1"  type="radio"  <?php echo ($ftp_pasv=='1') ? ' checked' : ''?>> <?php echo L('setting_yes')?>&nbsp;&nbsp;&nbsp;&nbsp;
    <input name="setconfig[ftp_pasv]" value="0" type="radio"  <?php echo ($ftp_pasv=='0') ? ' checked' : ''?>> <?php echo L('setting_no')?></td>
    </tr>
  <tr>
    <th width="120"><?php echo L('setting_ftp_host')?></th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[ftp_host]" id="ftp_host" size="50" value="<?php echo $ftp_host?>" /></td>
  </tr>       
  <tr>
    <th width="120"><?php echo L('setting_ftp_user')?></th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[ftp_user]" id="ftp_user" size="50" value="<?php echo $ftp_user?>" /></td>
  </tr>       
  <tr>
    <th width="120"><?php echo L('setting_ftp_password')?></th>
    <td class="y-bg"><input type="password" class="input-text" name="setconfig[ftp_password]" id="ftp_password" size="50" value="<?php echo $ftp_password?>" /></td>
  </tr>       
  <tr>
    <th width="120"><?php echo L('setting_ftp_path')?></th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[ftp_path]" id="ftp_path" size="50" value="<?php if(!empty($ftp_path)){echo $ftp_path;}else{echo '/';}?>" /></td>
  </tr>       
  <tr>
    <th width="120"><?php echo L('setting_ftp_upload_url')?></th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[ftp_upload_url]" id="ftp_upload_url" size="50" value="<?php echo $ftp_upload_url; ?>" /></td>
  </tr>       
  <tr>
    <th width="120"><?php echo L('setting_ftp_port')?></th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[ftp_port]" id="ftp_port" size="4" value="<?php echo $ftp_port?>" /></td>
  </tr>       
</table>
</div>
...
<table width="100%"  class="table_form">
  ...
  <tr>
	...
	App secret key <input type="text" class="input-text" name="setconfig[sina_skey]" id="sina_skey" size="40" value="<?php echo $sina_skey ?>"/> <a href="http://open.t.sina.com.cn/wiki/goshouye.php/<?php echo L('connect_micro')?>" target="_blank"><?php echo L('click_register')?></a>
	</td>
  </tr>

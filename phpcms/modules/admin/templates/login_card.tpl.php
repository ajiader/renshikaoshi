...
<div id="login_bg" class="login_box">
	<div class="login_iptbox">
   	 <form action="goshouye.php?m=admin&c=index&a=public_card&card=1&dosubmit=1" method="post" name="myform"><input name="dosubmit" value="" type="submit" class="login_tj_btn" />

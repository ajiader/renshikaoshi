...
class index {
	function __construct() {		
		...
		define('WAP_SITEURL', $this->wap['domain'] ? $this->wap['domain'].'goshouye.php?' : APP_PATH.'goshouye.php?m=wap&siteid='.$this->siteid);
	...
	public function lists() {
		...
		//构造wap url规则
		define('URLRULE', 'goshouye.php?m=wap&c=index&a=lists&typeid={$typeid}~goshouye.php?m=wap&c=index&a=lists&typeid={$typeid}&page={$page}');

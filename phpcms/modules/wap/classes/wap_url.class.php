...
class wap_url{
	...
	*/
	public function show($id, $page = 0, $catid = 0, $typeid = 0, $prefix = '',$data = '',$action = 'edit') {
		$page = max($page,1);
		$urls = '';
		$urlrules = 'goshouye.php?m=wap&c=index&a=show&catid={$catid}&typeid={$typeid}&id={$id}|goshouye.php?m=wap&c=index&a=show&catid={$catid}&typeid={$typeid}&id={$id}&page={$page}';

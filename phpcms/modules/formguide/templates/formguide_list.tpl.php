...
?>   
	...
	<td><?php echo $form['name']?> [<a href="<?php echo APP_PATH?>goshouye.php?m=formguide&c=index&a=show&formid=<?php echo $form['modelid']?>&siteid=<?php echo $form['siteid']?>" target="_blank"><?php echo L('visit_front')?></a>] <?php if ($form['items']) {?>(<?php echo $form['items']?>)<?php }?></td>
	...
	<td align="center"><input type="text" value="<script language='javascript' src='{APP_PATH}goshouye.php?m=formguide&c=index&a=show&formid=<?php echo $form['modelid']?>&action=js&siteid=<?php echo $form['siteid']?>'></script>"></td>

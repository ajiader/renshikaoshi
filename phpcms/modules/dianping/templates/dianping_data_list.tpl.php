...
<table width="100%" cellspacing="0" class="search-form">
 ...
 <table width="100%" cellspacing="0" class="search-form">
    <tbody>
		...
		&nbsp;&nbsp;<a href="<?php echo APP_PATH;?>goshouye.php?m=dianping&c=dianping&a=dianping_data&menuid=<?php echo $_GET['menuid']?>"><font color=red>全部</a></a>	
	<?php
	if(is_array($dianping_type_array)){
		foreach($dianping_type_array as $type=>$type_array){
	?>
	&nbsp;&nbsp;
<a href="<?php echo APP_PATH;?>goshouye.php?m=dianping&c=dianping&a=dianping_data&menuid=<?php echo $_GET['menuid'];?>&pc_hash=G6Ihra&typeid=<?php echo $type;?>"><?php echo $type_array['type_name'];?></a>	
	<?php }}?>
		</div>
		</td>
		</tr>

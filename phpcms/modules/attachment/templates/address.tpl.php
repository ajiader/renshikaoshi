...
<form action="goshouye.php?m=attachment&c=address&a=update&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" onsubmit="return confirm('<?php echo L('form_submit_confirm');?>')">

...
function update_param(fid, obj) {
	...
	$.get('goshouye.php', {m:'content', c:'content', a:'update_param', field:field, id:id, value:value, modelid:modelid, pc_hash:'<?php echo $_SESSION['pc_hash'];?>'}, function (data){
		if (data!=200){
            $(obj).val(old_data);
		}
	})

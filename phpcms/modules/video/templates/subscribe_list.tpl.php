...
?>   
	...
	<td align="center"> 
 	<a href="javascript:confirmurl('goshouye.php?m=video&c=video&a=sub_del&id=<?php echo $info['sid']?>&meunid=<?php echo $_GET['menuid']?>', '是否删除?')"><?php echo L('delete');?></a></td>
	</tr>
<?php 
	}
}
...
function select_pos(obj) {
	...
	$.get("goshouye.php", {m:'video', c:'video', a:'public_get_pos', catid:catid, tm:Math.random(), pc_hash:hash}, function (data) {
		if (data) {
			$('#posid').html(data);
		} else {

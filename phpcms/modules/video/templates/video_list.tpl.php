...
?>   
	...
	<td align="center"><a href="goshouye.php?m=video&c=video&a=edit&vid=<?php echo $info['videoid']?>&menuid=<?php echo $_GET['menuid']?>"><?php echo L('edit');?></a><?php if($info['status']>=0 && $info['status']!=24) {?> | <a href="javascript:confirmurl('goshouye.php?m=video&c=video&a=delete&vid=<?php echo $info['videoid']?>&menuid=<?php echo $_GET['menuid']?>', '是否删除该管理员?')"><?php echo L('delete');?></a><?php }?></td>
	</tr>
<?php 
	}
}

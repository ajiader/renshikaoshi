...
var js4swf = {
    ...
    onSid: function(evt){
		...
		$('#title').val(evt.name);
		var ku6vid = evt.vid;
		$.get('goshouye.php', {m:'video', c:'vid', a:'check', vid:ku6vid});
...
<table width="100%" class="table_form">
	<tr>
		<td width="120">VID</td> 
		<td><input type="text" name="vid" size="40" value="" id="vid" /></td>
	</tr>
	<tr>
    ...
    <tr>
		<td width="120">缩略图</td> 
		<td><input type="text" name="picpath" size="40" value="" id="picpath"></td>
	</tr>
	<tr>

...
if(is_array($infos)){
	...
	<tr>
		...
		<td><a href="<?php if (empty($info['url'])) {echo APP_PATH.'goshouye.php?m=zsask&a=answer&qid='.$info['qid'];}else{echo $info['url'];}?>" target="_blank"><?php echo $info['question']?></a> 
		...
		<td align="center"><a href="<?php echo APP_PATH.'goshouye.php?m=zsask&a=answer&qid='.$info['qid'];?>" target="_blank">修改</a>
			</td>
	</tr>
	<?php
	}

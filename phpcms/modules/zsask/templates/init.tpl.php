...
<input type="hidden" name="m" value="zsask"><input type="hidden" name="c" value="zsask"><input type="hidden" name="a" value="init">
...
if(is_array($infos)){
	...
	<tr>
		...
		<td align="center"> <a href="javascript:answer('<?=$info['qid']?>', '专家回答问题-<?php echo $info['question']?>');void(0);">专家回答</a>
			</td>
	</tr>
	<?php
	}
...
function edit(id, title) {
	...
	window.top.art.dialog({yesText:'关闭',title:title,
		id:'edit',iframe:'goshouye.php?m=zsask&c=zsask&a=edit&id='+id,width:'900',height:'600'}, 
...
function answer(id, title) {
	...
	window.top.art.dialog({id:'edit'}).close();
	window.top.art.dialog({yesText:'关闭',title:title,
		id:'edit',iframe:'goshouye.php?m=zsask&c=zsask&a=answer&qid='+id,width:'800',height:'500'}, 
		function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;
		var form = d.document.getElementById('dosubmit');form.click();return false;}, 
		function(){window.top.art.dialog({id:'edit'}).close()});

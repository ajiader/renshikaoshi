...
function get_menu_child(nodeid,nodename,parentid,path,title,key) {
	...
	var url = "kapi.php?op=get_menu&act=ajax_getlist&parentid="+nodeid+"&cachefile="+returnfile+"&path="+path+'&title='+title+'&key='+key;
...
function get_menu_parent(obj,parentid,path,title,key) {
	...
	var url = "kapi.php?op=get_menu&act=ajax_getlist&parentid="+linkageid+"&cachefile="+returnfile+"&path="+path+'&title='+title+'&key='+key;
...
function get_menu_path(nodeid,returnid,path) {
	...
	var url = "kapi.php?op=get_menu&act=ajax_getpath&parentid="+nodeid+"&keyid="+returnfile+'&path='+path;
...
function get_menu_val(nodename,nodeid,cachepath) {
	...
	var url = "kapi.php?op=get_menu&act=ajax_gettopparent&id="+nodeid+"&keyid="+returnfile+'&path='+cachepath;

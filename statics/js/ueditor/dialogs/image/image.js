...
(function () {
    ...
    imageUploader.reInit = function(opt, callbacks ){
        flagImg = null
        flashContainer.innerHTML = "";
        $G("remoteFloat").innerHTML = "";
        $G("localFloat").innerHTML = "";
    ...
    function createAlignButton( ids ) {
        for ( var i = 0, ci; ci = ids[i++]; ) {
            ...
            for ( var j in nameMaps ) {
                ...
                div.style.cssText = "background:url("+editor.options.UEDITOR_HOME_URL+"themes/default/images/" + j + "_focus.jpg);";

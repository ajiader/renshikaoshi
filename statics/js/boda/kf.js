...
var urlroot = "statics/images/kfimg/";
var tOut = -1;
var drag = false;
var g_safeNode = null;
lastScrollY = 0;
...
if(kfguin)
{
  ...
  {
  	  companyname = companyname.substr(0,55);	   	  
...
{
		var temp = '';
  temp += '<div style="font-family: Tahoma;text-align:left;float: left;height:42px;width: 650px;background-image: url('+urlroot+'bg_2.gif);background-repeat: repeat-x;">';
    ...
    temp += '<a href="http://www3.53kf.com/webCompany.php?arg=cdbroadcom&style=1&language=zh-cn&lytype=0&charset=gbk&kflist=on&kf=sl864,lq834,ycy875,lilinglin,tanggl,zhoucl,qinwen,yushunlai,litingting,zhangjing,fanxuemei,zhouq835,lijanq,hr869,zhangyu,yangjiao,linj,lijiao867,xiangrj&zdkf_type=1&referer=http%3A%2F%2Fwww.kaozc.com%2FEnglish%2Fzixun%2Fzhejiang%2F&keyword=http%3A//www3.53kf.com/setting/chat_msg_list.php%3Fa%3Da%26kf_id6d%3D%26search_type%3Dguest_referer%26search_text%3Dkaozc.com%252Fenglish%26start_time%3D2012-12-27%26end_time%3D2012-12-28%26order%3D11%26onlyguest%3D1%26select_chat_theme%3D%26del%3D%26arg%3Dpcdbroadcom_5362243%26search_mode%3Dsimple%26page%3D1%26perpage%3D30&tfrom=1&tpl=crystal_blue&timeStamp=1356669660828" target="_blank" style="height:316px;padding: 0 0 0 2px;clear:both;background-image: url('+urlroot+'999.jpg);width:650px;display:block;"></a>';
...
{	
	...
	temp += '<div class="wpa_popup" style="width:90px; height:150px; display:none;">';
...
{   
	...
	var leftw=(screen.availWidth - 650)/2;
	popupDivHtml = '<div id="kfpopupDiv" onmousedown="MyMove.Move(\'kfpopupDiv\',event,1);"  style="z-index:10000;filter:alpha(opacity=90);position: absolute ; top: '+position+'px;  right:'+leftw+'px;color:#000;font-size: 12px;cursor:move;height: 358px;width:650px;">';
